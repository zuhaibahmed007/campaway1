...
const listItems = document.querySelectorAll(
  "#hostlistingTab .nav-pills .nav-item button"
);
const listtab = document.querySelectorAll(
  "#hostlistingTab .tab-content .tab-pane"
);
const changeTab = (e) => {
  let index_id = Number(e.getAttribute("data-id"));
  listItems[index_id].classList.remove("active");
  listItems[index_id].setAttribute("aria-selected", false);
  listItems[index_id + 1].classList.add("active");
  listItems[index_id + 1].setAttribute("aria-selected", true);

  listtab[index_id].classList.remove("show");
  listtab[index_id].classList.remove("active");
  listtab[index_id + 1].classList.add("active");
  listtab[index_id + 1].classList.add("show");
};
